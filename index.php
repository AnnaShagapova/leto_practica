...
<body>
            ...
            <div class="menu">
                <div class="logo">
                    ...
                    <div class="btn"> 
                        ...
                        <a href="php/register.php" class="btn1">Регистрация</a>
                    </div>
                </div>
    ...
    <main>
       <div class="container">
                <a href="./index.php?sort=date_added" class="btn3" ><p>Сортировка по дате обновления</p></a>  
                <?php
            ...
            if ($sort == 'simple') {
                $result = mysqli_query($connect, "SELECT id_photo, img_path, name_photo, date_added, author_id, download_count, category_id FROM photos;");
            ...
            $result = mysqli_query($connect, "SELECT id_photo, img_path, name_photo, date_added, download_count, author_id, category_id FROM photos ORDER BY date_added desc;");
            while($row = mysqli_fetch_array($result)){
                $authorID = $row['author_id'];
                $authorQuery = mysqli_query($connect, "SELECT username FROM users WHERE id_user = '$authorID'");
                $authorRow = mysqli_fetch_array($authorQuery);
                ...
                echo "<div class='card'>
                    ...
                    echo "<div class='knopka'><a href='./index.php?sort=simple' class='btn4'><p>Назад</p></a></div>";       
            }  
            if ($sort == 'category') {
